...
tab1, tab2 = st.tabs(["Generator kampanii", "Statystyki i taski"])
with tab1:
    ...
    with c1:
        ...
        if st.session_state["api_key"]:
            ...
            option = st.number_input("Wybierz liczbe plakatów do wygenerowania:", min_value=1, max_value=3)
            if st.button("Generuj"):
                ...
                if not description:
                    ...
                    with c3:
                        ...
                        result = st.write_stream(spot)
                        st.session_state["spot"] = result
